...
class CreateVpisanPredmetTable extends Migration {
	...
	public function up()
	{
		Schema::create('vpisan_predmet', function(Blueprint $table)
		{
			...
			$table->primary(['sifra_predmeta','sifra_studijskega_programa','sifra_letnika','vpisna_stevilka','sifra_studijskega_leta','sifra_studijskega_leta_izvedbe_predmeta'],'PK_vpisan_predmet');
