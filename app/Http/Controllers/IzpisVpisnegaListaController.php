...
class IzpisVpisnegaListaController extends Controller {
	...
	public function vpisnilist($vs){
        ...
        #Ovde trebit uste predmetite da se ispiset
        ...
        $vse['vrstastudija'] = Vrsta_studija::where('sifra_vrste_studija', $vpis[0]->sifra_vrste_studija)->pluck('naziv_vrste_studija');
        ...
        $vse['potrdi'] = 1;
        return view('izpisvpisnegalista', ['vse'=>$vse]);
    }
