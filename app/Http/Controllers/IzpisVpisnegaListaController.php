...
class IzpisVpisnegaListaController extends Controller {
	...
	public function vpisnilist($vs){
        ...
        $vse['kraj'] = Obcina::where('sifra_obcine', $student[0]->sifra_obcine_rojstva)->pluck('naziv_obcine');
        ...
        $postna1 = $student[0]->postna_stevilka_stalno;
        $postna2 = $student[0]->postna_stevilka_zacasno;
        ...
        $vse['obcina1'] = Obcina::where('sifra_obcine', $student[0]->sifra_obcine_stalno)->pluck('naziv_obcine').
            ', '.Drzava::where('sifra_drzave', $student[0]->sifra_drzave_stalno)->pluck('naziv_drzave')."\t".$postna1;
        ...
        if($student[0]->sifra_obcine_zacasno)
            $vse['obcina2'] = Obcina::where('sifra_obcine', $student[0]->sifra_obcine_zacasno)->pluck('naziv_obcine').
                ', '.Drzava::where('sifra_drzave', $student[0]->sifra_drzave_zacasno)->pluck('naziv_drzave')."\t".$postna2;
        else
            $vse['obcina2'] = "";
